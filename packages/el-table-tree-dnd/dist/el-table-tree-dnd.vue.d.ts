import { TableProps, ElTableRef } from './types';

declare function __VLS_template(): Partial<Record<any, (_: {}) => any>> & Partial<Record<any, (_: {
    row: any;
    column: string;
    $index: any;
...
declare const __VLS_component: import('vue').DefineComponent<__VLS_WithDefaults<__VLS_TypePropsToOption<TableProps<any>>, {
    draggable: boolean;
    data: () => never[];
    columns: () => never[];
    rowKey: string;
    ...
    "node-drag-enter": (props: {
        dragSource: any;
        dropTarget: any;
    }) => void;
    "node-drag-leave": (props: {
        dragSource: any;
        dropTarget: any;
    }) => void;
    "node-drag-over": (props: {
        dragSource: any;
        dropTarget: any;
    }) => void;
    "node-drag-end": (props: {
    ...
    "selection-change": (data: any[]) => void;
    "size-change": (val: number) => void;
    "current-change": (val: number) => void;
}, string, import('vue').PublicProps, Readonly<import('vue').ExtractPropTypes<__VLS_WithDefaults<__VLS_TypePropsToOption<TableProps<any>>, {
    draggable: boolean;
    data: () => never[];
    columns: () => never[];
    rowKey: string;
    ...
    "onSelection-change"?: ((data: any[]) => any) | undefined;
    "onNode-drag-start"?: ((props: {
        dragSource: any;
    }) => any) | undefined;
    "onNode-drag-enter"?: ((props: {
        dragSource: any;
        dropTarget: any;
    }) => any) | undefined;
    "onNode-drag-leave"?: ((props: {
        dragSource: any;
        dropTarget: any;
    }) => any) | undefined;
    "onNode-drag-over"?: ((props: {
        dragSource: any;
        dropTarget: any;
    }) => any) | undefined;
    "onNode-drag-end"?: ((props: {
        dragSource: any;
        dropTarget: any;
    }) => any) | undefined;
    "onNode-drop"?: ((props: {
